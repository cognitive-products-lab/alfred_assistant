# Fiches de connaissance vides (stubs auto-generes) — a completer ou retirer

Trouve le 2026-07-05 lors du sweep de tests. Chaque fichier ci-dessous a `"source": "recreated_from_dashboard_manifest"`,
`"status": "draft"`, et un contenu vide (summary/links/use_cases/risks/key_points tous vides).
Decision a prendre : rediger le contenu reel, ou retirer ces entrees du manifest si le sujet nest plus pertinent.

Total : 75 fichiers

## cpl/business_strategy (15)
...
## professional/engineering/reasoning (15)
...
## professional/product_management/advanced (4)
