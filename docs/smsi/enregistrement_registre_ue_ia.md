...
> **Statut :** En attente (obligation non encore applicable)
...
**Classification actuelle :** Risque Limité (Art. 52)  
**Obligation Art. 49 :** Non applicable en l'état — réservé aux systèmes à haut risque

**Conditions de reclassification en haut risque (à surveiller) :**
- Utilisation dans les domaines de l'Annexe III : emploi, éducation, services essentiels, justice, biométrie
- Utilisation multi-utilisateurs à grande échelle
- Intégration dans des décisions automatisées impactant des droits fondamentaux
