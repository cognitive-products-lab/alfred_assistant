...
> **Date d'audit :** 2026-06-18 12:21 UTC
> **Données générées le :** 2026-06-18 12:21:59 UTC
...
| Indicateur | Valeur |
|---|---|
| **Score CPL global** | **55.0%** |
| **Grade** | **B** — Satisfaisant — plan d'action requis |
...
| RGPD-06 | Consentement renforcé données sensibles Art. 9 _Module ConsentArt9Manager + registre JSON horodaté — consentement explicite Art. 9 §2.a_ | Données sensibles | ✅ Atteint | ✓ |  |
...
| RGPD-09 | DPA formelle avec sous-traitants (OpenAI API…) | Accountability | ✅ Atteint | ✓ |  |
...
**Score : 40.3%** `[████████░░░░░░░░░░░░]`  
12 atteints · 1 partiels · 18 à faire
...
| ISO-24 | Procédure formelle de gestion des incidents (A.5.24) _Procédure PDCA complète avec RACI — niveaux P1→P4, outils, KPI, notifications réglementaires_ | Incidents | ✅ Atteint | ✓ |  |
...
| Champ | Valeur |
|---|---|
| Date du rapport | 2026-06-18 12:21 UTC |
