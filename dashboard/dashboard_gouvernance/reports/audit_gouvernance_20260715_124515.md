...
> **Date d'audit :** 2026-07-15 12:45 UTC
> **Données générées le :** 2026-07-15 12:45:15 UTC
...
| RGPD-04 | Droit d'effacement Art. 17 — erasure_command.py _Point d'entrée utilisateur créé et testé le 11/07/2026 — les fonctions sous-jacentes (compliance_manager.delete_user_data, long_term_memory.delete_all_memories) existaient depuis mai 2026 mais n'étaient invoquées par rien_ | Droits personnes | ✅ Atteint | ✓ |  |
...
| **Art. 16 — Rectification** | Droit d'effacement Art. 17 — erasure_command.py | ✅ Atteint | ✓ présente |
...
| Champ | Valeur |
|---|---|
| Date du rapport | 2026-07-15 12:45 UTC |
