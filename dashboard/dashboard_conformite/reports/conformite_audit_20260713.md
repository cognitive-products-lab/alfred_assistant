# Rapport Conformité ALFRED — 2026-07-13
...
- ✅ `RGPD-06` Droit à l'effacement — erasure_command.py — *conforme*
...
- ⏳ `RGPD-12` AIPD — comptes utilisateurs, préférences, conversations, PoC Hadoop (déploiement public) — *en_cours*
