...
KPI_CATALOG: list[KPIDefinition] = [
    ...
    KPIDefinition(
        ...
        target=None,
        base_status="OFF",
        status_reason="Nécessite une vérité terrain (quelles connaissances SONT pertinentes pour une requête) — n'existe pas : golden_dataset.py n'a pas de champ relevant_knowledge_ids.",
    ),
    KPIDefinition(
        ...
        target=None,
        base_status="OFF",
        status_reason="Même blocage que rag_recall_at_k.",
    ),
    KPIDefinition(
