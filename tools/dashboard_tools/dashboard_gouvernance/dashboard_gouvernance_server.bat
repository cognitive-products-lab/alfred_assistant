...
:: ROLE     : Recalcule les scores · Lance http.server 8001 · Ouvre dashboard_gouvernance.html
...
echo [ALFRED] http://localhost:8001/dashboard/dashboard_gouvernance/dashboard_gouvernance.html
echo.
