"""Process raw eyebrow images (white bg) into LOCKED v1.0 layer PNGs.

Crops content from white-background source images, converts white to
transparent alpha, scales to fit the eyebrows bbox [415,172,615,196]
(200x24px, center 515,184) and pastes onto a 1024x1536 transparent canvas.
"""
...
SRC_DIR = Path(r"D:\PROJET_ALFRED\ALFRED_PC\assets\avatars\avatar_medium\base_medium\eyebrows_raw")
...
BBOX = (415, 172, 615, 196)  # x0,y0,x1,y1
...
def white_to_alpha(img: Image.Image) -> Image.Image:
    ...
    if transparent_ratio > 0.10:
        # Source already has a real alpha channel (transparent background).
        return rgba
...
def place_on_canvas(content: Image.Image) -> Image.Image:
    # Scale to fit within BBOX_W x BBOX_H, preserving aspect ratio
...
def main():
    variants = {
        "eyebrows_neutral.png": SRC_DIR / "01_neutral.png",
        "eyebrows_raised.png": SRC_DIR / "02_raised.png",
        "eyebrows_furrowed.png": SRC_DIR / "03_furrowed.png",
        "eyebrows_one_raised.png": SRC_DIR / "04_one_raised.png",
    }
